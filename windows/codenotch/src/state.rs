...
pub struct Snapshot {
    ...
    pub drag: bool,
    /// Which provider rings the user wants shown
    pub providers: crate::config::ProviderVisibility,
    /// Screen edge: right | left | top | bottom
    pub edge: String,
    /// Accent choice key ("system" or hex id)
    pub accent: String,
    /// Resolved #RRGGBB for the page to paint the ample band
    pub accent_hex: String,
    /// Show the one-time community / Telegram card
...
impl Store {
    ...
    pub fn snapshot(
        ...
        lang_resolved: &str,
        drag: bool,
        providers: crate::config::ProviderVisibility,
        edge: String,
        accent: String,
        accent_hex: String,
        show_welcome: bool,
